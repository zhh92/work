...
TCL_LIBS='-ldl -lz -lpthread -lpthread -lieee -lm'

# Top-level directory in which Tcl's platform-independent files are
# installed.
TCL_PREFIX='/zhjs/sync/tcl'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='/zhjs/sync/tcl'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/zhjs/sync/tcl8.6.6/unix -ltcl8.6'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-L/zhjs/sync/tcl/lib -ltcl8.6'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-I/zhjs/sync/tcl/include'
...
# compiled.
TCL_SRC_DIR='/zhjs/sync/tcl8.6.6'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='/zhjs/sync/tcl/lib '
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/zhjs/sync/tcl8.6.6/unix -ltclstub8.6'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-L/zhjs/sync/tcl/lib -ltclstub8.6'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/zhjs/sync/tcl8.6.6/unix/libtclstub8.6.a'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='/zhjs/sync/tcl/lib/libtclstub8.6.a'
